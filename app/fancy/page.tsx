...
const galleryImages = Array.from({ length: 9 }, (_, i) => `/images/vehicles/fancy/gallery/anh(${i + 1}).jpg`);
          ...
          <div className="w-full aspect-[4/3] lg:aspect-square bg-gradient-to-br from-white to-slate-100 rounded-[3rem] p-10 flex items-center justify-center border border-white shadow-2xl shadow-slate-200/60 relative overflow-hidden">
            <AnimatePresence mode="wait">
              <motion.img 
                ...
                className="w-full h-full object-contain drop-shadow-xl z-10 cursor-grab active:cursor-grabbing"
                drag="x"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-widest mb-2 text-slate-800">
              Album <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-slate-500 to-[#4A5A75]">Ảnh</span>
            </h2>
