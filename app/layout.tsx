...
export const metadata: Metadata = {
  ...
  description: "Hệ thống phân phối Minh Anh chuyên phân phối các dòng xe máy điện, xe đạp điện, xe trợ lực điện với các thương hiệu Poweldd, TMT, Vinfast....",
